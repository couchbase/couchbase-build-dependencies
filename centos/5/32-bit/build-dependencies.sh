...
cp centos-5-x86-curl-7.21.4.tar.gz $currentdir/
cd $currentdir
rm -rf /opt/couchbase/*
...
cp centos-5-x86-libevent-2.0.11-stable.tar.gz $currentdir/
cd $currentdir
rm -rf /opt/couchbase/*
rm -rf v8
...
tar -zcvf centos-5-x86-v8-3.9.7.tar.gz /opt/couchbase/
cp centos-5-x86-v8-3.9.7.tar.gz $currentdir/
cd $currentdir
rm -rf /opt/couchbase/*
rm -rf icu4c
...
tar -zcvf centos-5-x86-icu4c-894be7.tar.gz /opt/couchbase/
cp centos-5-x86-icu4c-894be7.tar.gz $currentdir/
cd $currentdir
rm -rf /opt/couchbase/*
rm -rf gperftool
...
tar -zcvf centos-5-x86-gperftools-2.0.tar.gz /opt/couchbase/
cp centos-5-x86-gperftools-2.0.tar.gz $currentdir/
cd $currentdir
rm -rf /opt/couchbase/*
rm -rf snappy
...
make install
tar -zcvf centos-5-x86-snappy-894be7.tar.gz /opt/couchbase/
cp centos-5-x86-snappy-894be7.tar.gz  $currentdir/
...
tar -zcvf centos-5-x86-pysqlite-0ff6e.tar.gz /opt/couchbase
cp centos-5-x86-pysqlite-0ff6e.tar.gz $currentdir/
#build ctypes
cd $currentdir
rm -rf /opt/couchbase/*
rm -rf ctypes*
...
tar -zcvf centos-5-x86-ctypes-1.0.2.tar.gz /opt/couchbase
cp centos-5-x86-ctypes-1.0.2.tar.gz ../
#build otp
cd $currentdir
rm -rf /opt/couchbase/*
rm -rf otp
