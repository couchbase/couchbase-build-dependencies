...
tar -zcvf centos-5-x86-64-pysqlite-0ff6e.tar.gz /opt/couchbase
cp centos-5-x86-64-pysqlite-0ff6e.tar.gz $currentdir/
#build ctypes
cd $currentdir
rm -rf /opt/couchbase/*
rm -rf ctypes*
...
tar -zcvf centos-5-x86-64-ctypes-1.0.2.tar.gz /opt/couchbase
cp centos-5-x86-64-ctypes-1.0.2.tar.gz ../
#build otp
cd $currentdir
rm -rf /opt/couchbase/*
rm -rf otp
...
cp centos-5-x86-64-otp-OTP_R14B04.tar.gz $currentdir/
