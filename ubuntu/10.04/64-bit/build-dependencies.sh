...
cp ubuntu-10-04-x86-64-curl-7.21.4.tar.gz $currentdir/
cd $currentdir
rm -rf /opt/couchbase/*
...
cp ubuntu-10-04-x86-64-libevent-2.0.11-stable.tar.gz $currentdir/
cd $currentdir
rm -rf /opt/couchbase/*
rm -rf v8
...
tar -zcvf ubuntu-10-04-x86-64-v8-3.9.7.tar.gz /opt/couchbase/
cp ubuntu-10-04-x86-64-v8-3.9.7.tar.gz $currentdir/
cd $currentdir
rm -rf /opt/couchbase/*
rm -rf icu4c
...
tar -zcvf ubuntu-10-04-x86-64-icu4c-894be7.tar.gz /opt/couchbase/
cp ubuntu-10-04-x86-64-icu4c-894be7.tar.gz $currentdir/
cd $currentdir
rm -rf /opt/couchbase/*
rm -rf gperftool
...
cp ubuntu-10-04-x86-64-gperftools-2.0.tar.gz $currentdir/
cd $currentdir
rm -rf /opt/couchbase/*
rm -rf snappy
...
make install
tar -zcvf ubuntu-10-04-x86-64-snappy-894be7.tar.gz /opt/couchbase/
cp ubuntu-10-04-x86-64-snappy-894be7.tar.gz  $currentdir/
...
tar -zcvf ubuntu-10-04-x86-64-pysqlite-0ff6e.tar.gz /opt/couchbase
cp ubuntu-10-04-x86-64-pysqlite-0ff6e.tar.gz $currentdir/
#build ctypes
cd $currentdir
rm -rf /opt/couchbase/*
rm -rf ctypes*
...
tar -zcvf ubuntu-10-04-x86-64-ctypes-1.0.2.tar.gz /opt/couchbase
cp ubuntu-10-04-x86-64-ctypes-1.0.2.tar.gz ../
#build otp
cd $currentdir
rm -rf /opt/couchbase/*
rm -rf otp
...
cp ubuntu-10-04-x86-64-otp-OTP_R14B04.tar.gz $currentdir/
